...
sealed class Failure with _$Failure {
  ...
  const factory Failure.schedulingConflict(String message) = SchedulingConflictFailure;
  const factory Failure.invalidTimeRange(String message) = InvalidTimeRangeFailure;
