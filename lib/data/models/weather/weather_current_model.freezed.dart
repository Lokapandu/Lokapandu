...
as int,diffRad: null == diffRad ? _self.diffRad : diffRad // ignore: cast_nullable_to_non_nullable
as int,dni: null == dni ? _self.dni : dni // ignore: cast_nullable_to_non_nullable
as int,gti: null == gti ? _self.gti : gti // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
/// Create a copy of WeatherCurrentModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "last_updated_epoch")  int lastUpdatedEpoch, @JsonKey(name: "last_updated")  String lastUpdated, @JsonKey(name: "temp_c")  double tempC, @JsonKey(name: "temp_f")  double tempF, @JsonKey(name: "is_day")  int isDay, @JsonKey(name: "condition")  WeatherCurrentConditionModel condition, @JsonKey(name: "wind_mph")  double windMph, @JsonKey(name: "wind_kph")  double windKph, @JsonKey(name: "wind_degree")  int windDegree, @JsonKey(name: "wind_dir")  String windDir, @JsonKey(name: "pressure_mb")  int pressureMb, @JsonKey(name: "pressure_in")  double pressureIn, @JsonKey(name: "precip_mm")  int precipMm, @JsonKey(name: "precip_in")  int precipIn, @JsonKey(name: "humidity")  int humidity, @JsonKey(name: "cloud")  int cloud, @JsonKey(name: "feelslike_c")  double feelslikeC, @JsonKey(name: "feelslike_f")  double feelslikeF, @JsonKey(name: "windchill_c")  double windchillC, @JsonKey(name: "windchill_f")  double windchillF, @JsonKey(name: "heatindex_c")  double heatindexC, @JsonKey(name: "heatindex_f")  double heatindexF, @JsonKey(name: "dewpoint_c")  double dewpointC, @JsonKey(name: "dewpoint_f")  double dewpointF, @JsonKey(name: "vis_km")  int visKm, @JsonKey(name: "vis_miles")  int visMiles, @JsonKey(name: "uv")  double uv, @JsonKey(name: "gust_mph")  double gustMph, @JsonKey(name: "gust_kph")  double gustKph, @JsonKey(name: "short_rad")  int shortRad, @JsonKey(name: "diff_rad")  int diffRad, @JsonKey(name: "dni")  int dni, @JsonKey(name: "gti")  int gti)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WeatherCurrentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "last_updated_epoch")  int lastUpdatedEpoch, @JsonKey(name: "last_updated")  String lastUpdated, @JsonKey(name: "temp_c")  double tempC, @JsonKey(name: "temp_f")  double tempF, @JsonKey(name: "is_day")  int isDay, @JsonKey(name: "condition")  WeatherCurrentConditionModel condition, @JsonKey(name: "wind_mph")  double windMph, @JsonKey(name: "wind_kph")  double windKph, @JsonKey(name: "wind_degree")  int windDegree, @JsonKey(name: "wind_dir")  String windDir, @JsonKey(name: "pressure_mb")  int pressureMb, @JsonKey(name: "pressure_in")  double pressureIn, @JsonKey(name: "precip_mm")  int precipMm, @JsonKey(name: "precip_in")  int precipIn, @JsonKey(name: "humidity")  int humidity, @JsonKey(name: "cloud")  int cloud, @JsonKey(name: "feelslike_c")  double feelslikeC, @JsonKey(name: "feelslike_f")  double feelslikeF, @JsonKey(name: "windchill_c")  double windchillC, @JsonKey(name: "windchill_f")  double windchillF, @JsonKey(name: "heatindex_c")  double heatindexC, @JsonKey(name: "heatindex_f")  double heatindexF, @JsonKey(name: "dewpoint_c")  double dewpointC, @JsonKey(name: "dewpoint_f")  double dewpointF, @JsonKey(name: "vis_km")  int visKm, @JsonKey(name: "vis_miles")  int visMiles, @JsonKey(name: "uv")  double uv, @JsonKey(name: "gust_mph")  double gustMph, @JsonKey(name: "gust_kph")  double gustKph, @JsonKey(name: "short_rad")  int shortRad, @JsonKey(name: "diff_rad")  int diffRad, @JsonKey(name: "dni")  int dni, @JsonKey(name: "gti")  int gti)  $default,) {final _that = this;
switch (_that) {
case _WeatherCurrentModel():
return $default(_that.lastUpdatedEpoch,_that.lastUpdated,_that.tempC,_that.tempF,_that.isDay,_that.condition,_that.windMph,_that.windKph,_that.windDegree,_that.windDir,_that.pressureMb,_that.pressureIn,_that.precipMm,_that.precipIn,_that.humidity,_that.cloud,_that.feelslikeC,_that.feelslikeF,_that.windchillC,_that.windchillF,_that.heatindexC,_that.heatindexF,_that.dewpointC,_that.dewpointF,_that.visKm,_that.visMiles,_that.uv,_that.gustMph,_that.gustKph,_that.shortRad,_that.diffRad,_that.dni,_that.gti);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey(name: "feelslike_f") final  double feelslikeF;
...
@override@JsonKey(name: "heatindex_f") final  double heatindexF;
...
@override@JsonKey(name: "short_rad") final  int shortRad;
@override@JsonKey(name: "diff_rad") final  int diffRad;
@override@JsonKey(name: "dni") final  int dni;
@override@JsonKey(name: "gti") final  int gti;
