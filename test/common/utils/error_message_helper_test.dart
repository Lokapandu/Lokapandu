  ...
  group('ErrorMessageHelper', () {
    group('getReadableErrorMessage', () {
      ...
      test('should return cancellation message for user cancelled errors', () {
        ...
        expect(
          result,
          'Proses masuk dibatalkan. Silakan coba lagi jika ingin masuk.',
        );
      });

      test(
        'should return Google auth error message for Google sign-in issues',
        () {
          final result = ErrorMessageHelper.getReadableErrorMessage(
          ...
          expect(
            result,
            'Gagal mendapatkan akses dari Google. Silakan coba masuk lagi.',
          );
        },
      );
      ...
      test('should return rate limit message for too many attempts', () {
        ...
        expect(
          result,
          'Terlalu banyak percobaan. Silakan tunggu sebentar sebelum mencoba lagi.',
        );
      });
    });
    ...
    group('getActionSuggestion', () {
      ...
      test('should return network action for network errors', () {
        final result = ErrorMessageHelper.getActionSuggestion(
          'Network timeout',
        );
    ...
    group('isRecoverableError', () {
      ...
      test('should return false for configuration errors', () {
        final result = ErrorMessageHelper.isRecoverableError(
